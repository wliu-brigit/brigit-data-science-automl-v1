...
# Neo4j Browser. Everything persistent lives under codex_poc/out/.
...
OUT_DIR="$POC_DIR/out/neo4j"
DATA_DIR="$POC_DIR/out/neo4j-data"
LOGS_DIR="$POC_DIR/out/neo4j-logs"
...
Stop:
  bash $POC_DIR/scripts/stop_neo4j.sh
EOF
